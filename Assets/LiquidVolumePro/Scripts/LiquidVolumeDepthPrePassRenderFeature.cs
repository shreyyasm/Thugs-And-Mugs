...
namespace LiquidVolumeFX {
    ...
    public class LiquidVolumeDepthPrePassRenderFeature : ScriptableRendererFeature {
        ...
        class DepthPass : ScriptableRenderPass {
            ...
            {
                cameraTextureDescriptor.colorFormat = LiquidVolume.useFPRenderTextures
                ...
                {
                    RTHandle rtHandle = RTHandles.Alloc(cameraTextureDescriptor, name: "_MyCustomRT");
                ...
                if (interleavedRendering) {
                    ...
                    lvRenderers.ForEach((LiquidVolume lv) => {
                        if (lv != null && lv.isActiveAndEnabled) {
                            ...
                            // draw back face
                            cmd.SetRenderTarget(renderer.cameraColorTargetHandle, renderer.cameraDepthTargetHandle, 0, CubemapFace.Unknown, -1);
